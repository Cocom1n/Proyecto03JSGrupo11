class level2 extends Phaser.Scene{
    ...
    preload(){
        ...
        this.load.image('platform2-lvl2','../public/img/level2/platform2-lvl2.png');
        this.load.image('apple','../public/img/level2/apple.png');
        this.load.image('bomb2','../public/img/level2/bomb.png');
        this.load.spritesheet('dude-lvl2','../public/img/level2/dude.png', { frameWidth: 32, frameHeight: 48});
        //this.load.audio('playerJump2', '../public/sonido/level2/jump.mp3');
        //this.load.audio('explosion2', '../public/sonido/level2/explosion.mp3');
    }
